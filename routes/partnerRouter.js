...
.get(cors.cors, (req, res, next) => {                                          // If we receive a GET request from the HTTP client, then do the following...
...
.post(cors.corsWithOptions, authenticate.verifyUser, authenticate.verifyAdmin, (req, res, next) => {                                     // When we receive a POST request, then do the following...
...
.put(cors.corsWithOptions, authenticate.verifyUser, authenticate.verifyAdmin, (req, res) => {                                            // This is an update request
    res.statusCode = 403;
